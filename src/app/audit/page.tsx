    ...
    <div className="p-8">
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-slate-100 bg-slate-50">
              <th className="text-left px-4 py-3 font-medium text-slate-500">{"Čas"}</th>
              <th className="text-left px-4 py-3 font-medium text-slate-500">{"Uživatel"}</th>
              <th className="text-left px-4 py-3 font-medium text-slate-500">{"Akce"}</th>
              <th className="text-left px-4 py-3 font-medium text-slate-500">{"Entita"}</th>
              <th className="text-left px-4 py-3 font-medium text-slate-500">{"Detail"}</th>
              <th className="text-left px-4 py-3 font-medium text-slate-500">{"Hash"}</th>
            </tr>
          </thead>
      ...
      <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-green-50 border border-green-200 rounded-xl p-4 text-sm text-green-800">
          ...
          {"Všechny záznamy jsou konzistentní. Žádné narušení integrity nebylo detekováno."}
        </div>
        <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 text-sm text-blue-800">
          ...
          {"Každý záznam obsahuje hash předchozího záznamu. Jakýkoliv neoprávněný zásah do databáze způsobí nevalidní řetěz a spustí alarm."}
        </div>
      </div>
    </div>
  );
